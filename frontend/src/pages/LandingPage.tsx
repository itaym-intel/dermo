      ...
      >
        ...
        >
          <div className="text-center text-white max-w-2xl px-6">
            <h1 className="text-4xl md:text-7xl font-display mb-10 leading-snug drop-shadow-lg">
        ...
        <div className="text-center mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="card p-8">
              ...
              <h3 className="text-2xl font-display text-primary-900 mb-4">Upload Image</h3>
              <p className="text-xl text-primary-700">Take a clear photo of your skin condition or mole.</p>
            </div>
            <div className="card p-8">
              <div className="text-5xl mb-6">🤖</div>
              <h3 className="text-2xl font-display text-primary-900 mb-4">AI Analysis</h3>
              <p className="text-xl text-primary-700">Our advanced AI analyzes your image for potential concerns.</p>
            </div>
            <div className="card p-8">
              <div className="text-5xl mb-6">📋</div>
              <h3 className="text-2xl font-display text-primary-900 mb-4">Get Results</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
              <Link to="/skin-scanner" className="group">
                <div className="relative overflow-hidden rounded-3xl shadow-card hover:shadow-hover transition-all duration-300">
                  ...
                  <div className="relative p-8">
                    ...
                    <p className="text-xl text-primary-700 mb-8">Get a comprehensive analysis of your skin condition with our AI technology. Perfect for monitoring overall skin health and identifying potential concerns.</p>
              ...
              <Link to="/mole-scanner" className="group">
                <div className="relative overflow-hidden rounded-3xl shadow-card hover:shadow-hover transition-all duration-300">
                  ...
                  <div className="relative p-8">
                    ...
                    <p className="text-xl text-primary-700 mb-8">Monitor and analyze your moles for any concerning changes or patterns. Our AI helps track changes over time and provides early detection insights.</p>
                    <div className="flex items-center text-blue-600 font-medium text-xl">
                      Start Analysis
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
          ...
          <div className="text-center mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Instant Results</h3>
                <p className="text-xl text-primary-700">No more long waits just to get a consultation. Get your analysis in seconds, not days or weeks.</p>
              </div>
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Backed by Powerful Data</h3>
                <p className="text-xl text-primary-700">Our models are trained on the largest collection of publically available dermatology images and data.</p>
              </div>
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Open Source and Transparent</h3>
                <p className="text-xl text-primary-700">Our models are open source and transparent, so you can see how the models work and how they are trained.</p>
              </div>
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Cloud Based and Secure</h3>
                <p className="text-xl text-primary-700">Your data is encrypted using state of the art encryption and never shared without your consent.</p>
              </div>
            </div>
            <button 
          ...
          <div className="text-center mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div className="card p-8">
                ...
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Sarah M.</h3>
                <p className="text-xl text-primary-700">"The AI analysis was spot-on! It helped me catch a concerning mole early."</p>
              </div>
              <div className="card p-8">
                <div className="text-5xl mb-6">⭐️</div>
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">James L.</h3>
                <p className="text-xl text-primary-700">"Incredibly easy to use and the results were very detailed. Highly recommend!"</p>
              </div>
              <div className="card p-8">
                <div className="text-5xl mb-6">⭐️</div>
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Emma R.</h3>
                <p className="text-xl text-primary-700">"Peace of mind at my fingertips. The platform is a game-changer for skin health."</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Basic Plan</h3>
              ...
              <div className="card p-8">
                <h3 className="text-2xl font-display text-primary-900 mb-4 drop-shadow-md">Premium Plan</h3>
                <p className="text-3xl font-bold text-blue-600 mb-4">$FREE.99/mo</p>
                <ul className="text-primary-700 mb-6">
